#!/usr/bin/env python3
"""
GIF Builder - Core module for assembling frames into GIFs optimized for Discord.

This module provides the main interface for creating GIFs from programmatically
generated frames, with automatic optimization for Discord's requirements.
"""
...
class GIFBuilder:
    ...
    def save(
        ...
        """
        Save frames as optimized GIF for Discord.
